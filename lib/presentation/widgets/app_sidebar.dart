    ...
    builder: (_) => AlertDialog(
      ...
      content: const SingleChildScrollView(
        child: Text(
          ...
          '· Apple 로그인(iOS): 이메일, 이름(최초 1회), 사용자 ID\n'
          '· 이용자 입력: 식물 정보, 관리 기록, 사진\n'
          '· AI 상담(로그인·게스트): 채팅 내용 및 첨부 사진. '
          '대화 기록은 서버에 저장하지 않고 AI 처리에만 사용합니다.\n'
          '· 날씨 추천: 선택한 도시명(기기에 저장). GPS는 쓰지 않으며, '
          '미리 정한 도시 좌표만 날씨 조회에 사용합니다.\n'
          '· 기기 저장: 테마, 알림 설정, 날씨 추천 캐시\n'
          '· 앱 무결성: App Check 토큰(Play Integrity / DeviceCheck)\n\n'
          '2. 이용 목적\n'
          '· 계정 인증, 데이터 저장·동기화\n'
          ...
          'App Check, Gemini AI): 인증·저장·날씨 중계·AI 처리. '
          '날씨 추천 문구 생성 시 식물 물주기 정보가 Gemini에 전달될 수 있습니다.\n'
          '· Apple: iOS 로그인 인증\n'
          '· OpenWeatherMap: 도시 좌표 기반 날씨 예보(Cloud Functions 경유)\n'
          '위 서비스는 국외 서버에서 처리될 수 있습니다.\n\n'
          '4. 권한(선택)\n'
          '· 사진(갤러리): 식물 사진 등록·AI 첨부\n'
          '· 알림·정확한 알람: 물주기 알림\n'
          '위치(GPS) 권한은 사용하지 않습니다. 거부 시 해당 기능만 제한됩니다.\n\n'
          '5. 보관 및 삭제\n'
          '· 계정·식물 데이터는 이용 기간 동안 보관합니다.\n'
          '· 식물별 데이터는 앱에서 개별 삭제할 수 있습니다.\n'
          '· 계정과 서버 데이터는 앱의 「회원 탈퇴」로 삭제할 수 있습니다.\n'
          '· AI 대화는 서버에 보관하지 않습니다.\n'
          '· 기기에 남은 설정은 앱 삭제 시 제거됩니다.\n\n'
